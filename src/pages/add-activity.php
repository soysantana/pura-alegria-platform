    ...
    <div
        ...
        <main>
            <div class="mx-auto max-w-(--breakpoint-2xl) p-4 md:p-6">
                <!-- Breadcrumb Start -->
                <div x-data="{ pageName: `Agregar Actividades`}">
...
<!-- BEGIN MODAL -->
<?php include_once '../includes/activity/activity-add-modal.php'; ?>
<?php include_once '../includes/activity/activity-edit-modal.php'; ?>
