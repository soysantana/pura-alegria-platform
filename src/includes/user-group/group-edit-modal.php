  ...
  <div
    ...
    <div class="px-2 pr-14">
      <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
        Edita el grupo de usuarios
      </h4>
      <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
        Completa los datos para actualizar un grupo de usuarios.
      </p>
    </div>
    <form
      class="flex flex-col"
      action="/src/db/user-group/edit-group.php"
      method="POST">
      <div class="custom-scrollbar overflow-y-auto px-2">
        <div class="mt-2">
          <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
            <input type="hidden" id="groupId" name="groupId" x-model="editGroupId" />
