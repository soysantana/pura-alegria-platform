<div class="overflow-hidden rounded-2xl border border-gray-200 bg-white px-4 pt-4 pb-3 sm:px-6 dark:border-gray-800 dark:bg-white/[0.03]">
    ...
    <div class="max-w-full overflow-x-auto custom-scrollbar">
        <table class="min-w-full">
            ...
            <!-- table header end -->
            <?php $userGroups = find_all('user_groups'); ?>
            <!-- table body start -->
                    ...
                    <tr>
                                ...
                                <div class="flex items-center gap-3">
                                    <div>
                                        <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90">
                                            <?php echo remove_junk(ucfirst($ug['group_name'])); ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <td class="px-6 py-3 whitespace-nowrap first:pl-0">
                            <div class="flex items-center">
                                <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                                    <?php echo remove_junk($ug['group_level']); ?>
                                </p>
                            </div>
                        </td>
                        <td class="px-6 py-3 whitespace-nowrap first:pl-0">
                            <div class="flex items-center">
                                <?php
                                $status = remove_junk($ug['group_status']);
                        ...
                        <td class="px-6 py-3 whitespace-nowrap first:pl-0">
                            <div class="flex items-center space-x-2">
                                <?php $deleteActionUrl = '/src/db/user-group/delete-group.php'; ?>
                                <svg
                                    @click="isDeleteModal = true;
                                    deleteId = '<?php echo (int)$ug['id']; ?>';"
                                ...
                                <svg
                                    @click="isEditGroupModal = true;
                                    editGroupId = '<?php echo (int)$ug['id']; ?>';
                                    editGroupName = '<?php echo addslashes(remove_junk($ug['group_name'])); ?>';
                                    editGroupLevel = '<?php echo (int)$ug['group_level']; ?>';
                                    editGroupStatus = '<?php echo (int)$ug['group_status']; ?>';
                                    "
                                    class=" cursor-pointer hover:fill-error-500 dark:hover:fill-error-500 fill-gray-700 dark:fill-gray-400"
                                    width="18"
                                    height="18"
