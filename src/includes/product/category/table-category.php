<div class="rounded-2xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
  <div class="mb-4 flex flex-col gap-2 px-5 sm:flex-row sm:items-center sm:justify-between sm:px-6">
    <div>
      <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">
        Listado de las categorias y marcas
      </h3>
    </div>
    ...
    <div class="flex items-center gap-3">
      ...
      <div class="flex items-center gap-3">
        <button
          ...
          Agregar Nueva Categoria o Marca
  ...
  <div class="custom-scrollbar max-w-full overflow-x-auto overflow-y-visible px-5 sm:px-6">
    <table class="min-w-full">
      ...
      <?php $categories = find_all('categories'); ?>
          ...
          <tr>
            ...
            <td class="py-3">
              <div class="flex items-center space-x-2">
                <?php $deleteActionUrl = '/src/db/product/delete-category.php'; ?>
                <svg
                  @click="isDeleteModal = true;
                  deleteId = '<?php echo $cat['id']; ?>';
                  "
                ...
                <svg
                  @click="isEditCategoryModal = true;
                  editCategoryId = '<?php echo $cat['id']; ?>';
                  editCategoryName = '<?php echo addslashes(remove_junk($cat['name'])); ?>';
                  editCategoryType = '<?php echo addslashes(remove_junk($cat['status'])); ?>';
                  "
                  class=" cursor-pointer hover:fill-error-500 dark:hover:fill-error-500 fill-gray-700 dark:fill-gray-400"
                  width="18"
                  height="18"
