<div
  ...
  <div
    ...
    <!-- close btn -->
    <button
      @click="isEditCategoryModal = false"
    ...
    <div class="px-2 pr-14">
      <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
        Editar categoria o marca
      </h4>
      <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
        Actualiza una categoria o marca.
      </p>
    </div>
    <form action="/src/db/product/edit-category.php" method="POST" class="flex flex-col">
        ...
        <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
          ...
          <div class="col-span-2">
            <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
              Selecione si es categoria o marca
            </label>
            <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
              <select
                id="categoryType"
                name="categoryType"
                x-model="editCategoryType"
                required
                ...
                <option value="" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" disabled selected hidden>
                  Seleccione una categoría o marca
                </option>
                <option value="C" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                  Categoria
                </option>
                <option value="B" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                  Marca
                </option>
              </select>
          ...
          <div class="col-span-2">
            ...
            <input
              ...
              placeholder="Ingresa el nombre de la categoria o marca"
              required
              class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
          </div>
        </div>
