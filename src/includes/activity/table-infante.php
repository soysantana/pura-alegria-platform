<div
  ...
  <div class="w-full overflow-x-auto">
    <table class="min-w-full">
      ...
      <!-- table header end -->
      <?php $logs = find_all_activity_logs(); ?>
          ...
          <tr>
            <td class="py-3">
              <div class="flex items-center">
                <p
                  ...
                  <?php echo remove_junk(ucfirst($log['infant_name'])); ?>
                </p>
              </div>
            </td>
            <td class="py-3">
            ...
            <td class="py-3">
              <div class="flex items-center space-x-2">
                <?php $deleteActionUrl = '/src/db/infant/delete-activity-log.php'; ?>
                <svg
                  @click="isDeleteModal = true;
                  deleteId = '<?php echo $log['activity_id']; ?>';
                  "
                ...
                <svg
                  ...
                  editInfantId = '<?php echo base64_encode((int)$log['activity_id']); ?>';
                  editInfantName = '<?php echo addslashes(remove_junk($log['infant_id'])); ?>';
                  editInfantActName = '<?php echo addslashes(remove_junk($log['activity_id'])); ?>';
                  "
                  class=" cursor-pointer hover:fill-error-500 dark:hover:fill-error-500 fill-gray-700 dark:fill-gray-400"
                  width="18"
                  height="18"
