        ...
        <?php foreach ($activities as $act): ?>
          <tr>
            ...
            <td class="py-3">
              <div class="flex items-center">
                <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                  <?php echo remove_junk(ucfirst($act['category'])); ?>
                </p>
              </div>
            </td>
            <td class="py-3">
              <div class="flex items-center space-x-2">
                <?php $deleteActionUrl = '/src/db/activity/delete-activity.php'; ?>
                <svg
                  @click="isDeleteModal = true;
                  deleteId = '<?php echo $act['id']; ?>';
                  "
                ...
                <svg
                  @click="isEditActivityModal = true;
                  editActivityId = '<?php echo $act['id']; ?>';
                  editActivityName = '<?php echo addslashes(remove_junk($act['name'])); ?>';
                  editActivityCategory = '<?php echo addslashes(remove_junk($act['category'])); ?>';
                  editActivityDescription = '<?php echo addslashes(remove_junk($act['description'])); ?>';
                  "
                  class=" cursor-pointer hover:fill-error-500 dark:hover:fill-error-500 fill-gray-700 dark:fill-gray-400"
                  width="18"
                  height="18"
