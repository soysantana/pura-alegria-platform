<div
  ...
  <div
    ...
    <form action="/src/db/infant/add-infan-activity.php" method="POST" class="flex flex-col">
      <div class="px-2 overflow-y-auto custom-scrollbar">
        <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
          <?php $infants = find_my_infants(); ?>
          <input
            type="hidden"
            id="caregiverId"
            name="caregiverId"
            value="<?php echo remove_junk((int)$user['id']); ?>">
          <div>
          ...
          <div class="col-span-2">
            ...
            <input
              ...
              id="note"
              name="note"
              placeholder="Ingresa una nota para esta actividad"
