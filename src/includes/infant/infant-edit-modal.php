  ...
  <div
    ...
    <div class="px-2 pr-14">
      <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
        Modifica los datos del infante
      </h4>
      <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
        Aquí puedes modificar la información del infante.
      </p>
    </div>
    <form
      class="flex flex-col"
      action="/src/db/infant/edit-infant.php"
      method="POST"
